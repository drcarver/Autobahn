...
{
    [Table("RefIPEDSFASBPellGrantTransactions", Schema = "Finance")]
    public partial class RefIPEDSFASBPellGrantTransactions
    {
        public RefIPEDSFASBPellGrantTransactions()
        {
        ...
        [InverseProperty("RefIpedsfasbpellGrantTransactions")]
