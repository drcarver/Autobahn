...
namespace ScafoldADatabase.Entities
{
    ...
    /// </summary>
    [Table("RefPersonalInformationVerification", Schema = "Person")]
    public partial class RefPersonalInformationVerification
    {
        ...
        [InverseProperty("RefPersonalInformationVerifications")]
        public virtual Organization? RefJurisdiction { get; set; }
        [InverseProperty("RefPersonalInformationVerification")]
