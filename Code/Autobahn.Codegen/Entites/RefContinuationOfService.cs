...
namespace ScafoldADatabase.Entities
{
    ...
    /// </summary>
    [Table("RefContinuationOfService", Schema = "K12")]
    public partial class RefContinuationOfService
    {
        public RefContinuationOfService()
        {
        ...
        [InverseProperty("RefContinuationOfServices")]
        public virtual Organization? RefJurisdiction { get; set; }
        [InverseProperty("RefContinuationOfServicesReason")]
