...
namespace Autobahn.Education.Interfaces.Common
{
    ...
    public partial interface IStaffCredential : IAutobahnBase
    {
        ...
        /// </para>
        /// </summary>
        DateTime? CardiopulmonaryResuscitationCertification { get; set; }

        Boolean? CteinstructorIndustryCertification { get; set; }
        ...
        /// </para>
        /// </summary>
        DateTime? FirstAidCertification { get; set; }
        ...
        /// </para>
        /// </summary>
        Boolean? TechnologySkillsStandardsMet { get; set; }
