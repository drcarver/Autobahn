...
namespace Autobahn.Education.Interfaces.Facilities
{
    ...
    {
        #region IBuildingSpaceUtilization
        /// <summary>
        ...
        /// </para>
        /// </summary>
        Boolean? AvailableUtilizedInstructionalSpace { get; set; }
        ...
        /// </para>
        /// </summary>
        Boolean? BuildingCapacityFactorIndicator { get; set; }
        ...
        /// </para>
        /// </summary>
        Decimal? BuildingSpaceUtilizationArea { get; set; }
        ...
        /// </para>
        /// </summary>
        Boolean? BuildingUnassignedSpaceIndicator { get; set; }
