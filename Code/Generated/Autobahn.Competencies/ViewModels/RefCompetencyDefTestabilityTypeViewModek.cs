...
//* FileName:   RefCompetencyDefTestabilityTypeViewModel.cs
//**********************************************************
...
{
     /// <summary>
     /// The RefCompetencyDefTestabilityTypeViewModel
     /// </summary>
    public partial class RefCompetencyDefTestabilityTypeViewModel : BindableBase, IRefCompetencyDefTestabilityType
    {
...
#region Properties
        ...
        /// </summary>
        public void Load(IRefCompetencyDefTestabilityType model)
        {
            IsBusy = true;
            Id = model.Id;
