...
//* FileName:   RefCompetencySetCompletionCriteriaViewModel.cs
//**********************************************************
...
{
     /// <summary>
     /// The RefCompetencySetCompletionCriteriaViewModel
     /// </summary>
    public partial class RefCompetencySetCompletionCriteriaViewModel : BindableBase, IRefCompetencySetCompletionCriteria
    {
...
#region Properties
        ...
        /// </summary>
        public void Load(IRefCompetencySetCompletionCriteria model)
        {
            IsBusy = true;
            Id = model.Id;
