...
//* FileName:   RefISO6395LanguageFamilyViewModel.cs
//**********************************************************
...
{
     /// <summary>
     /// The RefISO6395LanguageFamilyViewModel
     /// </summary>
    public partial class RefISO6395LanguageFamilyViewModel : BindableBase, IRefISO6395LanguageFamily
    {
...
#region Properties
        ...
        /// </summary>
        public void Load(IRefISO6395LanguageFamily model)
        {
            IsBusy = true;
            Id = model.Id;
