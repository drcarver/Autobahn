...
//* FileName:   RefOrganizationTypeViewModel.cs
//**********************************************************

using Prism.Mvvm;
using Autobahn.Common.Interfaces;
using Autobahn.Autobahn.Reference.Interfaces;

namespace Autobahn.Reference.ViewModels
{
     /// <summary>
     /// The RefOrganizationTypeViewModel
     /// </summary>
    public partial class RefOrganizationTypeViewModel : BindableBase, IRefOrganizationType
    {
...
#region Properties
        ...
        /// <summary>
        /// Reference to an optional instance of the <see cref="RefOrganizationElementTypeId"/> model
        /// </summary>
        ...
        /// </summary>
        public void Load(IRefOrganizationType model)
        {
            IsBusy = true;
            Id = model.Id;
            ...
            RefOrganizationElementTypeId = model.RefOrganizationElementTypeId;
