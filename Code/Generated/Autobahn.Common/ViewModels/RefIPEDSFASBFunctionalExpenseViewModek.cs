...
//* FileName:   RefIPEDSFASBFunctionalExpenseViewModel.cs
//**********************************************************
...
{
     /// <summary>
     /// The RefIPEDSFASBFunctionalExpenseViewModel
     /// </summary>
    public partial class RefIPEDSFASBFunctionalExpenseViewModel : BindableBase, IRefIPEDSFASBFunctionalExpense
    {
...
#region Properties
        ...
        /// </summary>
        public void Load(IRefIPEDSFASBFunctionalExpense model)
        {
            IsBusy = true;
            Id = model.Id;
