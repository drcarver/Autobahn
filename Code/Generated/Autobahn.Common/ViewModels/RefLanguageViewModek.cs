...
//* FileName:   RefLanguageViewModel.cs
//**********************************************************
...
{
     /// <summary>
     /// The RefLanguageViewModel
     /// </summary>
    public partial class RefLanguageViewModel : BindableBase, IRefLanguage
    {
...
#region Properties
        ...
        /// </summary>
        public void Load(IRefLanguage model)
        {
            IsBusy = true;
            Id = model.Id;
