...
//* FileName:   RefStaffCompensationSourceTypeViewModel.cs
//**********************************************************
...
{
     /// <summary>
     /// The RefStaffCompensationSourceTypeViewModel
     /// </summary>
    public partial class RefStaffCompensationSourceTypeViewModel : BindableBase, IRefStaffCompensationSourceType
    {
...
#region Properties
        ...
        /// </summary>
        public void Load(IRefStaffCompensationSourceType model)
        {
            IsBusy = true;
            Id = model.Id;
