...
//* FileName:   RefInternetAccessTypeInResidenceViewModel.cs
//**********************************************************
...
{
     /// <summary>
     /// The RefInternetAccessTypeInResidenceViewModel
     /// </summary>
    public partial class RefInternetAccessTypeInResidenceViewModel : BindableBase, IRefInternetAccessTypeInResidence
    {
...
#region Properties
        ...
        /// </summary>
        public void Load(IRefInternetAccessTypeInResidence model)
        {
            IsBusy = true;
            Id = model.Id;
