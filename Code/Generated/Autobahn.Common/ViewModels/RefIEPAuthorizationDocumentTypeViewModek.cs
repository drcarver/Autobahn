...
//* FileName:   RefIEPAuthorizationDocumentTypeViewModel.cs
//**********************************************************
...
{
     /// <summary>
     /// The RefIEPAuthorizationDocumentTypeViewModel
     /// </summary>
    public partial class RefIEPAuthorizationDocumentTypeViewModel : BindableBase, IRefIEPAuthorizationDocumentType
    {
...
#region Properties
        ...
        /// </summary>
        public void Load(IRefIEPAuthorizationDocumentType model)
        {
            IsBusy = true;
            Id = model.Id;
