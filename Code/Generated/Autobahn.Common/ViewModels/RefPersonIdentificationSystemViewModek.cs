...
//* FileName:   RefPersonIdentificationSystemViewModel.cs
//**********************************************************
...
{
     /// <summary>
     /// The RefPersonIdentificationSystemViewModel
     /// </summary>
    public partial class RefPersonIdentificationSystemViewModel : BindableBase, IRefPersonIdentificationSystem
    {
...
#region Properties
        ...
        /// <summary>
        /// Reference to an optional instance of the <see cref="RefPersonIdentifierTypeId"/> model
        /// </summary>
        ...
        /// </summary>
        public void Load(IRefPersonIdentificationSystem model)
        {
            IsBusy = true;
            Id = model.Id;
            ...
            RefPersonIdentifierTypeId = model.RefPersonIdentifierTypeId;
