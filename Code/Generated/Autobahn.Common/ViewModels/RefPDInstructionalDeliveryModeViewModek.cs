...
//* FileName:   RefPDInstructionalDeliveryModeViewModel.cs
//**********************************************************
...
{
     /// <summary>
     /// The RefPDInstructionalDeliveryModeViewModel
     /// </summary>
    public partial class RefPDInstructionalDeliveryModeViewModel : BindableBase, IRefPDInstructionalDeliveryMode
    {
...
#region Properties
        ...
        /// </summary>
        public void Load(IRefPDInstructionalDeliveryMode model)
        {
            IsBusy = true;
            Id = model.Id;
