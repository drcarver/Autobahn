...
//* FileName:   RefEducationLevelViewModel.cs
//**********************************************************
...
{
     /// <summary>
     /// The RefEducationLevelViewModel
     /// </summary>
    public partial class RefEducationLevelViewModel : BindableBase, IRefEducationLevel
    {
...
#region Properties
        ...
        /// <summary>
        /// Reference to an optional instance of the <see cref="RefEducationLevelTypeId"/> model
        /// </summary>
        ...
        /// </summary>
        public void Load(IRefEducationLevel model)
        {
            IsBusy = true;
            Id = model.Id;
            ...
            RefEducationLevelTypeId = model.RefEducationLevelTypeId;
