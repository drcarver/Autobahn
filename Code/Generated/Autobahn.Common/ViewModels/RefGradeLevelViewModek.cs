...
//* FileName:   RefGradeLevelViewModel.cs
//**********************************************************
...
{
     /// <summary>
     /// The RefGradeLevelViewModel
     /// </summary>
    public partial class RefGradeLevelViewModel : BindableBase, IRefGradeLevel
    {
...
#region Properties
        ...
        /// <summary>
        /// Reference to an optional instance of the <see cref="RefGradeLevelTypeId"/> model
        /// </summary>
        ...
        /// </summary>
        public void Load(IRefGradeLevel model)
        {
            IsBusy = true;
            Id = model.Id;
            ...
            RefGradeLevelTypeId = model.RefGradeLevelTypeId;
