...
//* FileName:   RefElementaryMiddleAdditionalViewModel.cs
//**********************************************************
...
{
     /// <summary>
     /// The RefElementaryMiddleAdditionalViewModel
     /// </summary>
    public partial class RefElementaryMiddleAdditionalViewModel : BindableBase, IRefElementaryMiddleAdditional
    {
...
#region Properties
        ...
        /// </summary>
        public void Load(IRefElementaryMiddleAdditional model)
        {
            IsBusy = true;
            Id = model.Id;
