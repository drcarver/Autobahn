...
//* FileName:   RefHomelessNighttimeResidenceViewModel.cs
//**********************************************************
...
{
     /// <summary>
     /// The RefHomelessNighttimeResidenceViewModel
     /// </summary>
    public partial class RefHomelessNighttimeResidenceViewModel : BindableBase, IRefHomelessNighttimeResidence
    {
...
#region Properties
        ...
        /// </summary>
        public void Load(IRefHomelessNighttimeResidence model)
        {
            IsBusy = true;
            Id = model.Id;
