...
//* FileName:   RefCipCodeViewModel.cs
//**********************************************************
...
{
     /// <summary>
     /// The RefCipCodeViewModel
     /// </summary>
    public partial class RefCipCodeViewModel : BindableBase, IRefCipCode
    {
...
#region Properties
        ...
        /// </summary>
        public void Load(IRefCipCode model)
        {
            IsBusy = true;
            Id = model.Id;
