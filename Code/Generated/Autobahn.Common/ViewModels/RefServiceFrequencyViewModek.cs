...
//* FileName:   RefServiceFrequencyViewModel.cs
//**********************************************************
...
{
     /// <summary>
     /// The RefServiceFrequencyViewModel
     /// </summary>
    public partial class RefServiceFrequencyViewModel : BindableBase, IRefServiceFrequency
    {
...
#region Properties
        ...
        /// </summary>
        public void Load(IRefServiceFrequency model)
        {
            IsBusy = true;
            Id = model.Id;
