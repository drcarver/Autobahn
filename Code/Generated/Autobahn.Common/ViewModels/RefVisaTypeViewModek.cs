...
//* FileName:   RefVisaTypeViewModel.cs
//**********************************************************
...
{
     /// <summary>
     /// The RefVisaTypeViewModel
     /// </summary>
    public partial class RefVisaTypeViewModel : BindableBase, IRefVisaType
    {
...
#region Properties
        ...
        /// </summary>
        public void Load(IRefVisaType model)
        {
            IsBusy = true;
            Id = model.Id;
