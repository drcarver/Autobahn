...
//* FileName:   RefPersonLocationTypeViewModel.cs
//**********************************************************
...
{
     /// <summary>
     /// The RefPersonLocationTypeViewModel
     /// </summary>
    public partial class RefPersonLocationTypeViewModel : BindableBase, IRefPersonLocationType
    {
...
#region Properties
        ...
        /// <summary>
        /// Reference to an optional instance of the <see cref="RoleId"/> model
        /// </summary>
        public Guid? RoleId { get; set; }

        /// <summary>
        /// Reference to an optional instance of the <see cref="RefAddressTypeId"/> model
        /// </summary>
        ...
        /// </summary>
        public void Load(IRefPersonLocationType model)
        {
            IsBusy = true;
            Id = model.Id;
            ...
            RoleId = model.RoleId;
            RefAddressTypeId = model.RefAddressTypeId;
