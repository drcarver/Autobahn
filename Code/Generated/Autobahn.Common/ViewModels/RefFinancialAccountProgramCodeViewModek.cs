...
//* FileName:   RefFinancialAccountProgramCodeViewModel.cs
//**********************************************************
...
{
     /// <summary>
     /// The RefFinancialAccountProgramCodeViewModel
     /// </summary>
    public partial class RefFinancialAccountProgramCodeViewModel : BindableBase, IRefFinancialAccountProgramCode
    {
...
#region Properties
        ...
        /// </summary>
        public void Load(IRefFinancialAccountProgramCode model)
        {
            IsBusy = true;
            Id = model.Id;
