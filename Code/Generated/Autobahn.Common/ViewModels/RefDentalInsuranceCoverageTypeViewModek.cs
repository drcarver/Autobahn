...
//* FileName:   RefDentalInsuranceCoverageTypeViewModel.cs
//**********************************************************
...
{
     /// <summary>
     /// The RefDentalInsuranceCoverageTypeViewModel
     /// </summary>
    public partial class RefDentalInsuranceCoverageTypeViewModel : BindableBase, IRefDentalInsuranceCoverageType
    {
...
#region Properties
        ...
        /// </summary>
        public void Load(IRefDentalInsuranceCoverageType model)
        {
            IsBusy = true;
            Id = model.Id;
