...
//* FileName:   RefApipInteractionTypeViewModel.cs
//**********************************************************
...
{
     /// <summary>
     /// The RefApipInteractionTypeViewModel
     /// </summary>
    public partial class RefApipInteractionTypeViewModel : BindableBase, IRefApipInteractionType
    {
...
#region Properties
        /// <summary>
        /// Reference to a required instance of the <see cref="RefAPIPInteractionTypeId"/> model
        /// </summary>
        ...
        /// </summary>
        public void Load(IRefApipInteractionType model)
        {
            IsBusy = true;
            Id = model.Id;
