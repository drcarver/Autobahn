...
namespace Autobahn.Common.ViewModels
{
    ...
    public partial class IncidentViewModel : ViewModelBase, Interfaces.IIncident
    {
        ...
        {
            new ReferenceModelBase { Id=Guid.Parse("3316a48f-700c-43f8-b5ca-79ee74999bcf"), Code="Firearm", Description="Firearm", Definition="Any weapon (including a starter gun) which will or is designed to or may readily be converted to expel a projectile by the action of an explosive;  the frame or receiver of any such weapon; any firearm muffler or firearm silencer; or any destructive device.", SortOrder=Convert.ToDecimal("0.00") },
            new ReferenceModelBase { Id=Guid.Parse("722b5d1a-f3cf-41d2-8c3c-04619d7befc0"), Code="Handgun", Description="Handgun", Definition="Any firearm which has a short stock and is designed to be held and fired by the use of a single hand.", SortOrder=Convert.ToDecimal("2.00") },
            new ReferenceModelBase { Id=Guid.Parse("23643992-56e1-4af2-a92f-7005e9cd44a4"), Code="Shotgun", Description="Shotgun", Definition="A weapon designed or redesigned, made or remade, and intended to be fired from the shoulder and designed or redesigned and made or remade to use the  energy of an explosive to fire through a smooth bore either a number of ball shots or a single projectile for each single pull of the trigger.", SortOrder=Convert.ToDecimal("4.00") },
            new ReferenceModelBase { Id=Guid.Parse("fb88861e-24fa-4090-824a-e262ac01e1db"), Code="Rifle", Description="Rifle", Definition="A weapon designed or redesigned, made or remade, and intended to be fired from the shoulder and designed or redesigned and made or remade to use the energy of an explosive to fire only a single projectile through a rifled bore for each single pull of the trigger.", SortOrder=Convert.ToDecimal("6.00") },
            new ReferenceModelBase { Id=Guid.Parse("f1d01bf5-d95e-4181-bd71-2643d92ed846"), Code="OtherFirearm", Description="Other Firearm", Definition="Other type of firearm", SortOrder=Convert.ToDecimal("8.00") },
            new ReferenceModelBase { Id=Guid.Parse("c52b1f4b-83b7-4fca-aa4d-83022cc31801"), Code="Knife", Description="Knife", Definition="The weapon involved was a knife.", SortOrder=Convert.ToDecimal("10.00") },
            new ReferenceModelBase { Id=Guid.Parse("f5991c05-4906-44d7-8dce-318971f04fc0"), Code="KnifeLessThanTwoPointFiveInches", Description="Knife Less Than 2.5 Inches", Definition="Knife with blade length less than 2.5 inches - the weapon involved was a knife with a blade less than 2.5 inches in length.", SortOrder=Convert.ToDecimal("12.00") },
            new ReferenceModelBase { Id=Guid.Parse("57ad9a2e-952a-4aa6-be93-89d6710dc054"), Code="KnifeLessThanThreeInches", Description="Knife Less Than Three Inches", Definition="Knife with blade length less than 3 inches in length - the weapon involved was a knife with a blade at least 2.5 inches in length, but less than 3 inches in length.", SortOrder=Convert.ToDecimal("14.00") },
            new ReferenceModelBase { Id=Guid.Parse("f98b72d7-3ddc-4b31-a137-448fe86827d8"), Code="KnifeGreaterThanThreeInches", Description="Knife Greater Than Three Inches", Definition="Knife with blade length greater than or equal to 3 inches - the weapon involved was a knife with a blade 3 inches or greater in length.", SortOrder=Convert.ToDecimal("16.00") },
            new ReferenceModelBase { Id=Guid.Parse("4a973cab-e263-49ac-a5e4-b39dc1ae887c"), Code="OtherSharpObject", Description="Other sharp object", Definition="The weapon involved was another type of sharp object, (e.g., razor blade, ice pick, dirk, Chinese star, other pointed instrument [used as a weapon]).", SortOrder=Convert.ToDecimal("18.00") },
            new ReferenceModelBase { Id=Guid.Parse("425a75cf-acfc-4d80-883f-40d6ea76c9cb"), Code="OtherObject", Description="Other object", Definition="The weapon involved was another known object (e.g., chain, nunchakus, brass knuckle, billy club, electrical weapon or device [stun gun], BB or pellet gun).", SortOrder=Convert.ToDecimal("20.00") },
            new ReferenceModelBase { Id=Guid.Parse("99c578b7-81ed-4c64-8ece-773aa3043949"), Code="Substance", Description="Substance used as weapon", Definition="The weapon involved was a substance (e.g., mace, tear gas) that was used as a weapon.", SortOrder=Convert.ToDecimal("22.00") },
            new ReferenceModelBase { Id=Guid.Parse("c4758f01-7278-4690-8cd7-730c362d0aa7"), Code="OtherWeapon", Description="Other weapon", Definition="The incident involved a weapon other than those described above.", SortOrder=Convert.ToDecimal("24.00") },
            new ReferenceModelBase { Id=Guid.Parse("13c5c7f3-c4f0-4a9c-b51c-566f3f3aee27"), Code="None", Description="None", Definition="No weapon was used in the incident", SortOrder=Convert.ToDecimal("26.00") },
            new ReferenceModelBase { Id=Guid.Parse("2ced0bc5-ca10-4055-b84b-301a3b39a813"), Code="Unknown", Description="Unknown weapon", Definition="A weapon was used in the incident, but the type is unknown.", SortOrder=Convert.ToDecimal("28.00") },
        };
        #endregion
    }
}
