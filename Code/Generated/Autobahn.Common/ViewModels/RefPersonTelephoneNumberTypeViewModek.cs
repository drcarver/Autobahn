...
//* FileName:   RefPersonTelephoneNumberTypeViewModel.cs
//**********************************************************
...
{
     /// <summary>
     /// The RefPersonTelephoneNumberTypeViewModel
     /// </summary>
    public partial class RefPersonTelephoneNumberTypeViewModel : BindableBase, IRefPersonTelephoneNumberType
    {
...
#region Properties
        ...
        /// </summary>
        public void Load(IRefPersonTelephoneNumberType model)
        {
            IsBusy = true;
            Id = model.Id;
