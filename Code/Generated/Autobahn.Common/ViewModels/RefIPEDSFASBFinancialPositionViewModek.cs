...
//* FileName:   RefIPEDSFASBFinancialPositionViewModel.cs
//**********************************************************
...
{
     /// <summary>
     /// The RefIPEDSFASBFinancialPositionViewModel
     /// </summary>
    public partial class RefIPEDSFASBFinancialPositionViewModel : BindableBase, IRefIPEDSFASBFinancialPosition
    {
...
#region Properties
        ...
        /// </summary>
        public void Load(IRefIPEDSFASBFinancialPosition model)
        {
            IsBusy = true;
            Id = model.Id;
