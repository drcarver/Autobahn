...
//* FileName:   RefStaffPerformanceLevelViewModel.cs
//**********************************************************
...
{
     /// <summary>
     /// The RefStaffPerformanceLevelViewModel
     /// </summary>
    public partial class RefStaffPerformanceLevelViewModel : BindableBase, IRefStaffPerformanceLevel
    {
...
#region Properties
        ...
        /// </summary>
        public void Load(IRefStaffPerformanceLevel model)
        {
            IsBusy = true;
            Id = model.Id;
