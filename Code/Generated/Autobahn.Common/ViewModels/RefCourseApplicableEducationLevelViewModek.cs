...
//* FileName:   RefCourseApplicableEducationLevelViewModel.cs
//**********************************************************
...
{
     /// <summary>
     /// The RefCourseApplicableEducationLevelViewModel
     /// </summary>
    public partial class RefCourseApplicableEducationLevelViewModel : BindableBase, IRefCourseApplicableEducationLevel
    {
...
#region Properties
        ...
        /// </summary>
        public void Load(IRefCourseApplicableEducationLevel model)
        {
            IsBusy = true;
            Id = model.Id;
