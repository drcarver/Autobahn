...
//* FileName:   RefWIOABarrierstoEmploymentViewModel.cs
//**********************************************************
...
{
     /// <summary>
     /// The RefWIOABarrierstoEmploymentViewModel
     /// </summary>
    public partial class RefWIOABarrierstoEmploymentViewModel : BindableBase, IRefWIOABarrierstoEmployment
    {
...
#region Properties
        ...
        /// </summary>
        public void Load(IRefWIOABarrierstoEmployment model)
        {
            IsBusy = true;
            Id = model.Id;
