...
//* FileName:   RefFinancialAidApplicationTypeViewModel.cs
//**********************************************************
...
{
     /// <summary>
     /// The RefFinancialAidApplicationTypeViewModel
     /// </summary>
    public partial class RefFinancialAidApplicationTypeViewModel : BindableBase, IRefFinancialAidApplicationType
    {
...
#region Properties
        ...
        /// </summary>
        public void Load(IRefFinancialAidApplicationType model)
        {
            IsBusy = true;
            Id = model.Id;
