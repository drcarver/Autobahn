...
//* FileName:   RefInternetPerformanceInResidenceViewModel.cs
//**********************************************************
...
{
     /// <summary>
     /// The RefInternetPerformanceInResidenceViewModel
     /// </summary>
    public partial class RefInternetPerformanceInResidenceViewModel : BindableBase, IRefInternetPerformanceInResidence
    {
...
#region Properties
        ...
        /// </summary>
        public void Load(IRefInternetPerformanceInResidence model)
        {
            IsBusy = true;
            Id = model.Id;
