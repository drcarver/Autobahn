...
//* FileName:   RefCountryViewModel.cs
//**********************************************************
...
{
     /// <summary>
     /// The RefCountryViewModel
     /// </summary>
    public partial class RefCountryViewModel : BindableBase, IRefCountry
    {
...
#region Properties
        ...
        /// </summary>
        public void Load(IRefCountry model)
        {
            IsBusy = true;
            Id = model.Id;
