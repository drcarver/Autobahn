...
//* FileName:   RefERAdministrativeDataSourceViewModel.cs
//**********************************************************
...
{
     /// <summary>
     /// The RefERAdministrativeDataSourceViewModel
     /// </summary>
    public partial class RefERAdministrativeDataSourceViewModel : BindableBase, IRefERAdministrativeDataSource
    {
...
#region Properties
        ...
        /// </summary>
        public void Load(IRefERAdministrativeDataSource model)
        {
            IsBusy = true;
            Id = model.Id;
