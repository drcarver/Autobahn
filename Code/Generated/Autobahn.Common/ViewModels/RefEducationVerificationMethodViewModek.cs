...
//* FileName:   RefEducationVerificationMethodViewModel.cs
//**********************************************************
...
{
     /// <summary>
     /// The RefEducationVerificationMethodViewModel
     /// </summary>
    public partial class RefEducationVerificationMethodViewModel : BindableBase, IRefEducationVerificationMethod
    {
...
#region Properties
        ...
        /// </summary>
        public void Load(IRefEducationVerificationMethod model)
        {
            IsBusy = true;
            Id = model.Id;
