...
//* FileName:   RefIncidentMultipleOffenseTypeViewModel.cs
//**********************************************************
...
{
     /// <summary>
     /// The RefIncidentMultipleOffenseTypeViewModel
     /// </summary>
    public partial class RefIncidentMultipleOffenseTypeViewModel : BindableBase, IRefIncidentMultipleOffenseType
    {
...
#region Properties
        ...
        /// </summary>
        public void Load(IRefIncidentMultipleOffenseType model)
        {
            IsBusy = true;
            Id = model.Id;
