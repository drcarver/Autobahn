...
//* FileName:   RefRecordStatusCreatorEntityViewModel.cs
//**********************************************************
...
{
     /// <summary>
     /// The RefRecordStatusCreatorEntityViewModel
     /// </summary>
    public partial class RefRecordStatusCreatorEntityViewModel : BindableBase, IRefRecordStatusCreatorEntity
    {
...
#region Properties
        ...
        /// </summary>
        public void Load(IRefRecordStatusCreatorEntity model)
        {
            IsBusy = true;
            Id = model.Id;
