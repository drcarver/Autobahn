...
//* FileName:   RefAcademicTermDesignatorViewModel.cs
//**********************************************************
...
{
     /// <summary>
     /// The RefAcademicTermDesignatorViewModel
     /// </summary>
    public partial class RefAcademicTermDesignatorViewModel : BindableBase, IRefAcademicTermDesignator
    {
...
#region Properties
        ...
        /// </summary>
        public void Load(IRefAcademicTermDesignator model)
        {
            IsBusy = true;
            Id = model.Id;
