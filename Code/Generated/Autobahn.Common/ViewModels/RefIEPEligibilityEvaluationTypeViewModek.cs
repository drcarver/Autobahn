...
//* FileName:   RefIEPEligibilityEvaluationTypeViewModel.cs
//**********************************************************
...
{
     /// <summary>
     /// The RefIEPEligibilityEvaluationTypeViewModel
     /// </summary>
    public partial class RefIEPEligibilityEvaluationTypeViewModel : BindableBase, IRefIEPEligibilityEvaluationType
    {
...
#region Properties
        ...
        /// </summary>
        public void Load(IRefIEPEligibilityEvaluationType model)
        {
            IsBusy = true;
            Id = model.Id;
