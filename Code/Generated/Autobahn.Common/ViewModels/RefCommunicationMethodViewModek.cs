...
//* FileName:   RefCommunicationMethodViewModel.cs
//**********************************************************
...
{
     /// <summary>
     /// The RefCommunicationMethodViewModel
     /// </summary>
    public partial class RefCommunicationMethodViewModel : BindableBase, IRefCommunicationMethod
    {
...
#region Properties
        ...
        /// </summary>
        public void Load(IRefCommunicationMethod model)
        {
            IsBusy = true;
            Id = model.Id;
