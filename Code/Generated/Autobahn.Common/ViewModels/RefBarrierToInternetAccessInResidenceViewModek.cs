...
//* FileName:   RefBarrierToInternetAccessInResidenceViewModel.cs
//**********************************************************
...
{
     /// <summary>
     /// The RefBarrierToInternetAccessInResidenceViewModel
     /// </summary>
    public partial class RefBarrierToInternetAccessInResidenceViewModel : BindableBase, IRefBarrierToInternetAccessInResidence
    {
...
#region Properties
        ...
        /// </summary>
        public void Load(IRefBarrierToInternetAccessInResidence model)
        {
            IsBusy = true;
            Id = model.Id;
