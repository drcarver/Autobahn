...
//* FileName:   RefFinancialAccountRevenueCodeViewModel.cs
//**********************************************************
...
{
     /// <summary>
     /// The RefFinancialAccountRevenueCodeViewModel
     /// </summary>
    public partial class RefFinancialAccountRevenueCodeViewModel : BindableBase, IRefFinancialAccountRevenueCode
    {
...
#region Properties
        ...
        /// </summary>
        public void Load(IRefFinancialAccountRevenueCode model)
        {
            IsBusy = true;
            Id = model.Id;
