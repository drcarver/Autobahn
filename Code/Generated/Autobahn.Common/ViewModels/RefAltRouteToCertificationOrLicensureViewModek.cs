...
//* FileName:   RefAltRouteToCertificationOrLicensureViewModel.cs
//**********************************************************
...
{
     /// <summary>
     /// The RefAltRouteToCertificationOrLicensureViewModel
     /// </summary>
    public partial class RefAltRouteToCertificationOrLicensureViewModel : BindableBase, IRefAltRouteToCertificationOrLicensure
    {
...
#region Properties
        ...
        /// </summary>
        public void Load(IRefAltRouteToCertificationOrLicensure model)
        {
            IsBusy = true;
            Id = model.Id;
