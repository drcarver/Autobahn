...
//* FileName:   RefFinancialExpenditureObjectCodeViewModel.cs
//**********************************************************
...
{
     /// <summary>
     /// The RefFinancialExpenditureObjectCodeViewModel
     /// </summary>
    public partial class RefFinancialExpenditureObjectCodeViewModel : BindableBase, IRefFinancialExpenditureObjectCode
    {
...
#region Properties
        ...
        /// </summary>
        public void Load(IRefFinancialExpenditureObjectCode model)
        {
            IsBusy = true;
            Id = model.Id;
