...
//* FileName:   RefFinancialExpenditureFunctionCodeViewModel.cs
//**********************************************************
...
{
     /// <summary>
     /// The RefFinancialExpenditureFunctionCodeViewModel
     /// </summary>
    public partial class RefFinancialExpenditureFunctionCodeViewModel : BindableBase, IRefFinancialExpenditureFunctionCode
    {
...
#region Properties
        ...
        /// </summary>
        public void Load(IRefFinancialExpenditureFunctionCode model)
        {
            IsBusy = true;
            Id = model.Id;
