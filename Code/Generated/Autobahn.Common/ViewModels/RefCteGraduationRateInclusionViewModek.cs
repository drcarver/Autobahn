...
//* FileName:   RefCteGraduationRateInclusionViewModel.cs
//**********************************************************
...
{
     /// <summary>
     /// The RefCteGraduationRateInclusionViewModel
     /// </summary>
    public partial class RefCteGraduationRateInclusionViewModel : BindableBase, IRefCteGraduationRateInclusion
    {
...
#region Properties
        ...
        /// </summary>
        public void Load(IRefCteGraduationRateInclusion model)
        {
            IsBusy = true;
            Id = model.Id;
