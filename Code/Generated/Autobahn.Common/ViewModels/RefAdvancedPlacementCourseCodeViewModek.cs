...
//* FileName:   RefAdvancedPlacementCourseCodeViewModel.cs
//**********************************************************
...
{
     /// <summary>
     /// The RefAdvancedPlacementCourseCodeViewModel
     /// </summary>
    public partial class RefAdvancedPlacementCourseCodeViewModel : BindableBase, IRefAdvancedPlacementCourseCode
    {
...
#region Properties
        ...
        /// </summary>
        public void Load(IRefAdvancedPlacementCourseCode model)
        {
            IsBusy = true;
            Id = model.Id;
