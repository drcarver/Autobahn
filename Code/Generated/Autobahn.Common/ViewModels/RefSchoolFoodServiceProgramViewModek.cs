...
//* FileName:   RefSchoolFoodServiceProgramViewModel.cs
//**********************************************************
...
{
     /// <summary>
     /// The RefSchoolFoodServiceProgramViewModel
     /// </summary>
    public partial class RefSchoolFoodServiceProgramViewModel : BindableBase, IRefSchoolFoodServiceProgram
    {
...
#region Properties
        ...
        /// </summary>
        public void Load(IRefSchoolFoodServiceProgram model)
        {
            IsBusy = true;
            Id = model.Id;
