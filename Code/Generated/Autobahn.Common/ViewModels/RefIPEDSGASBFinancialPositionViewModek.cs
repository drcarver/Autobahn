...
//* FileName:   RefIPEDSGASBFinancialPositionViewModel.cs
//**********************************************************
...
{
     /// <summary>
     /// The RefIPEDSGASBFinancialPositionViewModel
     /// </summary>
    public partial class RefIPEDSGASBFinancialPositionViewModel : BindableBase, IRefIPEDSGASBFinancialPosition
    {
...
#region Properties
        ...
        /// </summary>
        public void Load(IRefIPEDSGASBFinancialPosition model)
        {
            IsBusy = true;
            Id = model.Id;
