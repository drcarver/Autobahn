...
//* FileName:   RefCourseSectionAssessmentReportingMethodViewModel.cs
//**********************************************************
...
{
     /// <summary>
     /// The RefCourseSectionAssessmentReportingMethodViewModel
     /// </summary>
    public partial class RefCourseSectionAssessmentReportingMethodViewModel : BindableBase, IRefCourseSectionAssessmentReportingMethod
    {
...
#region Properties
        ...
        /// </summary>
        public void Load(IRefCourseSectionAssessmentReportingMethod model)
        {
            IsBusy = true;
            Id = model.Id;
