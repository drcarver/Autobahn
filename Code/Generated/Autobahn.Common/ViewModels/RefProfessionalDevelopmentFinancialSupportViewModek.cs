...
//* FileName:   RefProfessionalDevelopmentFinancialSupportViewModel.cs
//**********************************************************
...
{
     /// <summary>
     /// The RefProfessionalDevelopmentFinancialSupportViewModel
     /// </summary>
    public partial class RefProfessionalDevelopmentFinancialSupportViewModel : BindableBase, IRefProfessionalDevelopmentFinancialSupport
    {
...
#region Properties
        ...
        /// </summary>
        public void Load(IRefProfessionalDevelopmentFinancialSupport model)
        {
            IsBusy = true;
            Id = model.Id;
