...
//* FileName:   RefIPEDSGASBFunctionalExpenseViewModel.cs
//**********************************************************
...
{
     /// <summary>
     /// The RefIPEDSGASBFunctionalExpenseViewModel
     /// </summary>
    public partial class RefIPEDSGASBFunctionalExpenseViewModel : BindableBase, IRefIPEDSGASBFunctionalExpense
    {
...
#region Properties
        ...
        /// </summary>
        public void Load(IRefIPEDSGASBFunctionalExpense model)
        {
            IsBusy = true;
            Id = model.Id;
