...
//* FileName:   RefDoctoralExamsRequiredCodeViewModel.cs
//**********************************************************
...
{
     /// <summary>
     /// The RefDoctoralExamsRequiredCodeViewModel
     /// </summary>
    public partial class RefDoctoralExamsRequiredCodeViewModel : BindableBase, IRefDoctoralExamsRequiredCode
    {
...
#region Properties
        ...
        /// </summary>
        public void Load(IRefDoctoralExamsRequiredCode model)
        {
            IsBusy = true;
            Id = model.Id;
