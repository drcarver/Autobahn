...
//* FileName:   RefCarnegieBasicClassificationViewModel.cs
//**********************************************************
...
{
     /// <summary>
     /// The RefCarnegieBasicClassificationViewModel
     /// </summary>
    public partial class RefCarnegieBasicClassificationViewModel : BindableBase, IRefCarnegieBasicClassification
    {
...
#region Properties
        ...
        /// </summary>
        public void Load(IRefCarnegieBasicClassification model)
        {
            IsBusy = true;
            Id = model.Id;
