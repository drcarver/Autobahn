...
//* FileName:   RefPsLepTypeViewModel.cs
//**********************************************************
...
{
     /// <summary>
     /// The RefPsLepTypeViewModel
     /// </summary>
    public partial class RefPsLepTypeViewModel : BindableBase, IRefPsLepType
    {
...
#region Properties
        ...
        /// </summary>
        public void Load(IRefPsLepType model)
        {
            IsBusy = true;
            Id = model.Id;
