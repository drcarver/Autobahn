...
//* FileName:   RefFinancialAidVeteransBenefitTypeViewModel.cs
//**********************************************************
...
{
     /// <summary>
     /// The RefFinancialAidVeteransBenefitTypeViewModel
     /// </summary>
    public partial class RefFinancialAidVeteransBenefitTypeViewModel : BindableBase, IRefFinancialAidVeteransBenefitType
    {
...
#region Properties
        ...
        /// </summary>
        public void Load(IRefFinancialAidVeteransBenefitType model)
        {
            IsBusy = true;
            Id = model.Id;
