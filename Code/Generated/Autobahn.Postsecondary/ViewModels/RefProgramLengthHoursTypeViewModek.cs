...
//* FileName:   RefProgramLengthHoursTypeViewModel.cs
//**********************************************************
...
{
     /// <summary>
     /// The RefProgramLengthHoursTypeViewModel
     /// </summary>
    public partial class RefProgramLengthHoursTypeViewModel : BindableBase, IRefProgramLengthHoursType
    {
...
#region Properties
        ...
        /// </summary>
        public void Load(IRefProgramLengthHoursType model)
        {
            IsBusy = true;
            Id = model.Id;
