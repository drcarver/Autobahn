...
//* FileName:   RefTransferReadyViewModel.cs
//**********************************************************
...
{
     /// <summary>
     /// The RefTransferReadyViewModel
     /// </summary>
    public partial class RefTransferReadyViewModel : BindableBase, IRefTransferReady
    {
...
#region Properties
        ...
        /// </summary>
        public void Load(IRefTransferReady model)
        {
            IsBusy = true;
            Id = model.Id;
