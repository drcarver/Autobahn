...
//* FileName:   RefPSProgramLevelViewModel.cs
//**********************************************************
...
{
     /// <summary>
     /// The RefPSProgramLevelViewModel
     /// </summary>
    public partial class RefPSProgramLevelViewModel : BindableBase, IRefPSProgramLevel
    {
...
#region Properties
        ...
        /// </summary>
        public void Load(IRefPSProgramLevel model)
        {
            IsBusy = true;
            Id = model.Id;
