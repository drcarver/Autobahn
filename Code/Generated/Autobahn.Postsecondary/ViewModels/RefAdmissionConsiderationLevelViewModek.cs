...
//* FileName:   RefAdmissionConsiderationLevelViewModel.cs
//**********************************************************
...
{
     /// <summary>
     /// The RefAdmissionConsiderationLevelViewModel
     /// </summary>
    public partial class RefAdmissionConsiderationLevelViewModel : BindableBase, IRefAdmissionConsiderationLevel
    {
...
#region Properties
        ...
        /// </summary>
        public void Load(IRefAdmissionConsiderationLevel model)
        {
            IsBusy = true;
            Id = model.Id;
