...
//* FileName:   RefCourseInstructionSiteTypeViewModel.cs
//**********************************************************
...
{
     /// <summary>
     /// The RefCourseInstructionSiteTypeViewModel
     /// </summary>
    public partial class RefCourseInstructionSiteTypeViewModel : BindableBase, IRefCourseInstructionSiteType
    {
...
#region Properties
        ...
        /// </summary>
        public void Load(IRefCourseInstructionSiteType model)
        {
            IsBusy = true;
            Id = model.Id;
