...
//* FileName:   RefDistanceEducationCourseEnrollmentViewModel.cs
//**********************************************************
...
{
     /// <summary>
     /// The RefDistanceEducationCourseEnrollmentViewModel
     /// </summary>
    public partial class RefDistanceEducationCourseEnrollmentViewModel : BindableBase, IRefDistanceEducationCourseEnrollment
    {
...
#region Properties
        ...
        /// </summary>
        public void Load(IRefDistanceEducationCourseEnrollment model)
        {
            IsBusy = true;
            Id = model.Id;
