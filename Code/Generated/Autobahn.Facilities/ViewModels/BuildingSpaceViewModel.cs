...
namespace Autobahn.Facilities.ViewModels
{
    ...
    public partial class BuildingSpaceViewModel : ViewModelBase, Interfaces.IBuildingSpace
    {
        ...
        {
            new ReferenceModelBase { Id=Guid.Parse("011d8603-df58-4110-8f8f-41236a45bd28"), Code="02633", Description="Administration", Definition="Administration is the primary use of a space, as determined by its physical layout and built-in systems and equipment, regardless of its original design.", SortOrder=Convert.ToDecimal("2.00") },
            new ReferenceModelBase { Id=Guid.Parse("49d4ec6e-96d0-4b57-b925-abb7a562798a"), Code="02634", Description="Assembly", Definition="Assembly is the primary use of a space, as determined by its physical layout and built-in systems and equipment, regardless of its original design.", SortOrder=Convert.ToDecimal("4.00") },
            new ReferenceModelBase { Id=Guid.Parse("5fee3b0d-659e-4bbc-bcf5-41d7974d6a79"), Code="02631", Description="Athletic", Definition="Athletic is the primary use of a space, as determined by its physical layout and built-in systems and equipment, regardless of its original design.", SortOrder=Convert.ToDecimal("6.00") },
            new ReferenceModelBase { Id=Guid.Parse("e6974458-b950-4d74-990a-98f99b5e1c48"), Code="02628", Description="Basic classroom", Definition="Basic classroom is the primary use of a space, as determined by its physical layout and built-in systems and equipment, regardless of its original design.", SortOrder=Convert.ToDecimal("8.00") },
            new ReferenceModelBase { Id=Guid.Parse("6c7eb69f-85eb-4581-b6ee-b87747573baa"), Code="02635", Description="Corridors", Definition="Corridors is the primary use of a space, as determined by its physical layout and built-in systems and equipment, regardless of its original design.", SortOrder=Convert.ToDecimal("10.00") },
            new ReferenceModelBase { Id=Guid.Parse("95422362-e7f6-404e-9069-cd08c121765f"), Code="02639", Description="Dormitory room", Definition="Dormitory room is the primary use of a space, as determined by its physical layout and built-in systems and equipment, regardless of its original design.", SortOrder=Convert.ToDecimal("12.00") },
            new ReferenceModelBase { Id=Guid.Parse("5979b4d5-82bd-4f61-9597-1f478cf2ceb5"), Code="02638", Description="Food service", Definition="Food service is the primary use of a space, as determined by its physical layout and built-in systems and equipment, regardless of its original design.", SortOrder=Convert.ToDecimal("14.00") },
            new ReferenceModelBase { Id=Guid.Parse("e4f6b7ce-d4bf-4699-bcaa-e5d87e41f61c"), Code="02630", Description="Library/media", Definition="Library/media is the primary use of a space, as determined by its physical layout and built-in systems and equipment, regardless of its original design.", SortOrder=Convert.ToDecimal("16.00") },
            new ReferenceModelBase { Id=Guid.Parse("ae20dd05-5709-4785-84ef-bc5767882b7f"), Code="02773", Description="Multi-purpose room", Definition="Multi-purpose room is the primary use of a space, as determined by its physical layout and built-in systems and equipment, regardless of its original design.", SortOrder=Convert.ToDecimal("18.00") },
            new ReferenceModelBase { Id=Guid.Parse("09d1ade5-8654-4794-9ce5-14292750f901"), Code="02636", Description="Operational support", Definition="Operational support is the primary use of a space, as determined by its physical layout and built-in systems and equipment, regardless of its original design.", SortOrder=Convert.ToDecimal("20.00") },
            new ReferenceModelBase { Id=Guid.Parse("56aaaab8-eb1d-492b-866a-af1f6cbfe5c3"), Code="03017", Description="Restroom", Definition="Restroom is the primary use of a space, as determined by its physical layout and built-in systems and equipment, regardless of its original design.", SortOrder=Convert.ToDecimal("22.00") },
            new ReferenceModelBase { Id=Guid.Parse("abc320aa-fe29-4687-9591-272699daedf0"), Code="02629", Description="Specialty classroom", Definition="Specialty classroom is the primary use of a space, as determined by its physical layout and built-in systems and equipment, regardless of its original design.", SortOrder=Convert.ToDecimal("24.00") },
            new ReferenceModelBase { Id=Guid.Parse("e5196def-2fb2-494a-9b1e-86ff8e561a2c"), Code="02637", Description="Storage", Definition="Storage is the primary use of a space, as determined by its physical layout and built-in systems and equipment, regardless of its original design.", SortOrder=Convert.ToDecimal("26.00") },
            new ReferenceModelBase { Id=Guid.Parse("fa301745-d1a3-4480-b103-42150a3519fc"), Code="02788", Description="Storage - hazardous materials", Definition="Storage - hazardous materials is the primary use of a space, as determined by its physical layout and built-in systems and equipment, regardless of its original design.", SortOrder=Convert.ToDecimal("28.00") },
            new ReferenceModelBase { Id=Guid.Parse("675bcecc-5e5a-4bf0-859a-fdda494f7ef5"), Code="02632", Description="Student support", Definition="Student support is the primary use of a space, as determined by its physical layout and built-in systems and equipment, regardless of its original design.", SortOrder=Convert.ToDecimal("30.00") },
            new ReferenceModelBase { Id=Guid.Parse("f66eb04a-2f22-4626-9b53-3d62c112618d"), Code="09999", Description="Other", Definition="The primary use of a space, as determined by its physical layout and built-in systems and equipment, regardless of its original design is in a category not yet defined in CEDS.", SortOrder=Convert.ToDecimal("32.00") },
        };
        #endregion
    }
}
