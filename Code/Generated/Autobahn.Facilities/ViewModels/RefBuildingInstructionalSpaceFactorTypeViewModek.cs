...
//* FileName:   RefBuildingInstructionalSpaceFactorTypeViewModel.cs
//**********************************************************
...
{
     /// <summary>
     /// The RefBuildingInstructionalSpaceFactorTypeViewModel
     /// </summary>
    public partial class RefBuildingInstructionalSpaceFactorTypeViewModel : BindableBase, IRefBuildingInstructionalSpaceFactorType
    {
...
#region Properties
        ...
        /// </summary>
        public void Load(IRefBuildingInstructionalSpaceFactorType model)
        {
            IsBusy = true;
            Id = model.Id;
