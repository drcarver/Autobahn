...
//* FileName:   RefBuildingIndoorAthleticOrPhysEdSpaceTypeViewModel.cs
//**********************************************************
...
{
     /// <summary>
     /// The RefBuildingIndoorAthleticOrPhysEdSpaceTypeViewModel
     /// </summary>
    public partial class RefBuildingIndoorAthleticOrPhysEdSpaceTypeViewModel : BindableBase, IRefBuildingIndoorAthleticOrPhysEdSpaceType
    {
...
#region Properties
        ...
        /// </summary>
        public void Load(IRefBuildingIndoorAthleticOrPhysEdSpaceType model)
        {
            IsBusy = true;
            Id = model.Id;
