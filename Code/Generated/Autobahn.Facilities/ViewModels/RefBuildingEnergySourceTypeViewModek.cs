...
//* FileName:   RefBuildingEnergySourceTypeViewModel.cs
//**********************************************************
...
{
     /// <summary>
     /// The RefBuildingEnergySourceTypeViewModel
     /// </summary>
    public partial class RefBuildingEnergySourceTypeViewModel : BindableBase, IRefBuildingEnergySourceType
    {
...
#region Properties
        ...
        /// </summary>
        public void Load(IRefBuildingEnergySourceType model)
        {
            IsBusy = true;
            Id = model.Id;
