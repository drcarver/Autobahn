...
//* FileName:   RefFacilityConstructionDateTypeViewModel.cs
//**********************************************************
...
{
     /// <summary>
     /// The RefFacilityConstructionDateTypeViewModel
     /// </summary>
    public partial class RefFacilityConstructionDateTypeViewModel : BindableBase, IRefFacilityConstructionDateType
    {
...
#region Properties
        ...
        /// </summary>
        public void Load(IRefFacilityConstructionDateType model)
        {
            IsBusy = true;
            Id = model.Id;
