...
//* FileName:   RefBuildingSchoolDesignTypeViewModel.cs
//**********************************************************
...
{
     /// <summary>
     /// The RefBuildingSchoolDesignTypeViewModel
     /// </summary>
    public partial class RefBuildingSchoolDesignTypeViewModel : BindableBase, IRefBuildingSchoolDesignType
    {
...
#region Properties
        ...
        /// </summary>
        public void Load(IRefBuildingSchoolDesignType model)
        {
            IsBusy = true;
            Id = model.Id;
