...
//* FileName:   RefBuildingScienceSpecialtySpaceTypeViewModel.cs
//**********************************************************
...
{
     /// <summary>
     /// The RefBuildingScienceSpecialtySpaceTypeViewModel
     /// </summary>
    public partial class RefBuildingScienceSpecialtySpaceTypeViewModel : BindableBase, IRefBuildingScienceSpecialtySpaceType
    {
...
#region Properties
        ...
        /// </summary>
        public void Load(IRefBuildingScienceSpecialtySpaceType model)
        {
            IsBusy = true;
            Id = model.Id;
