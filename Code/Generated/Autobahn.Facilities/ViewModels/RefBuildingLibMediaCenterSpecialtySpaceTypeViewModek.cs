...
//* FileName:   RefBuildingLibMediaCenterSpecialtySpaceTypeViewModel.cs
//**********************************************************
...
{
     /// <summary>
     /// The RefBuildingLibMediaCenterSpecialtySpaceTypeViewModel
     /// </summary>
    public partial class RefBuildingLibMediaCenterSpecialtySpaceTypeViewModel : BindableBase, IRefBuildingLibMediaCenterSpecialtySpaceType
    {
...
#region Properties
        ...
        /// </summary>
        public void Load(IRefBuildingLibMediaCenterSpecialtySpaceType model)
        {
            IsBusy = true;
            Id = model.Id;
