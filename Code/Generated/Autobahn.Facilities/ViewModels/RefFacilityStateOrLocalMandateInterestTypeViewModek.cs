...
//* FileName:   RefFacilityStateOrLocalMandateInterestTypeViewModel.cs
//**********************************************************
...
{
     /// <summary>
     /// The RefFacilityStateOrLocalMandateInterestTypeViewModel
     /// </summary>
    public partial class RefFacilityStateOrLocalMandateInterestTypeViewModel : BindableBase, IRefFacilityStateOrLocalMandateInterestType
    {
...
#region Properties
        ...
        /// </summary>
        public void Load(IRefFacilityStateOrLocalMandateInterestType model)
        {
            IsBusy = true;
            Id = model.Id;
