...
//* FileName:   RefFacilityFederalMandateInterestTypeViewModel.cs
//**********************************************************
...
{
     /// <summary>
     /// The RefFacilityFederalMandateInterestTypeViewModel
     /// </summary>
    public partial class RefFacilityFederalMandateInterestTypeViewModel : BindableBase, IRefFacilityFederalMandateInterestType
    {
...
#region Properties
        ...
        /// </summary>
        public void Load(IRefFacilityFederalMandateInterestType model)
        {
            IsBusy = true;
            Id = model.Id;
