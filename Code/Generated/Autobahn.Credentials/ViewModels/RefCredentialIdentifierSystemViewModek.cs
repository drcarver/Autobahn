...
//* FileName:   RefCredentialIdentifierSystemViewModel.cs
//**********************************************************
...
{
     /// <summary>
     /// The RefCredentialIdentifierSystemViewModel
     /// </summary>
    public partial class RefCredentialIdentifierSystemViewModel : BindableBase, IRefCredentialIdentifierSystem
    {
...
#region Properties
        ...
        /// </summary>
        public void Load(IRefCredentialIdentifierSystem model)
        {
            IsBusy = true;
            Id = model.Id;
