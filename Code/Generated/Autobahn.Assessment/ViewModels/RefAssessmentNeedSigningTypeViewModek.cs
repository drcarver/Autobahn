...
//* FileName:   RefAssessmentNeedSigningTypeViewModel.cs
//**********************************************************
...
{
     /// <summary>
     /// The RefAssessmentNeedSigningTypeViewModel
     /// </summary>
    public partial class RefAssessmentNeedSigningTypeViewModel : BindableBase, IRefAssessmentNeedSigningType
    {
...
#region Properties
        ...
        /// </summary>
        public void Load(IRefAssessmentNeedSigningType model)
        {
            IsBusy = true;
            Id = model.Id;
