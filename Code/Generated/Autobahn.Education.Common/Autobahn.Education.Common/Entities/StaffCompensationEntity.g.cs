...
/// </summary>
[Table("StaffCompensation", Schema = "Common")]
public partial class StaffCompensationEntity : EntityBase, IStaffCompensation
{
    ...
    /// </para>
    /// </summary>
    [ForeignKey("RefStaffCompensationSourceType")]
    ...
    /// </para>
    /// </summary>
    [Comment("The annual sum of payments given to staff in addition to their regular wages.")]
    ...
    /// </para>
    /// </summary>
    [Comment("The salary or wage a person is paid before deductions (excluding differentials) but including annuities.")]
    ...
    /// </para>
    /// </summary>
    [Comment("Contributions made by the school district, municipal, state, federal and other government agencies for the teacher's or early learning provider's health insurance, prorated to the specific school or local provider agency indicated on the record, not including contributions made by the teacher or early learning provider.")]
    ...
    /// </para>
    /// </summary>
    [Comment("Compensation paid to a staff member based on their years of service.")]
    ...
    /// </para>
    /// </summary>
    [Comment("All other benefits paid by the school district, municipal, state, federal, and other government agencies for the teacher or early learning provider, prorated to the specific school or local provider agency indicated on the record, not including retirement and health insurance benefits or contributions made by the teacher or early learning provider.")]
    ...
    /// </para>
    /// </summary>
    [Comment("Sum of retirement, health, and all other benefits, or total benefits paid by the school district, municipal, state, federal and other government agencies for the teacher's or early learning provider's health insurance, prorated to the specific school or local provider agency indicated on the record, not including contributions made by the teacher or early learning provider.")]
    ...
    /// </para>
    /// </summary>
    [Comment("Total annualized salary of staff at the specific school/program indicated on the record in the school/program year  specified on the record.")]
