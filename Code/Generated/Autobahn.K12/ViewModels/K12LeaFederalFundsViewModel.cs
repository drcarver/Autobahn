...
namespace Autobahn.K12.ViewModels
{
    ...
    public partial class K12LeaFederalFundsViewModel : ViewModelBase, Interfaces.IK12LeaFederalFunds
    {
        ...
        {
            new ReferenceModelBase { Id=Guid.Parse("77619fa6-7e7f-4979-8536-0cd10d75624e"), Code="01", Description="Teacher recruitment and retention", Definition="Teacher recruitment and retention, including the use of signing bonuses and other financial incentives", SortOrder=Convert.ToDecimal("1.00") },
            new ReferenceModelBase { Id=Guid.Parse("b64b6bc2-9ec8-42ae-81a7-1aca6b9e55ef"), Code="02", Description="Teacher professional development", Definition="Teacher professional development, including programs that train teachers to utilize technology to improve teaching and to train special needs teachers", SortOrder=Convert.ToDecimal("2.00") },
            new ReferenceModelBase { Id=Guid.Parse("29355963-51d7-4d6f-8fc0-a3864bc0bba1"), Code="03", Description="Educational technology", Definition="Educational technology, including software and hardware as described in Title II, Part D", SortOrder=Convert.ToDecimal("3.00") },
            new ReferenceModelBase { Id=Guid.Parse("bd0f921e-3945-4c4e-98b6-20d473751f16"), Code="04", Description="Parental involvement activities", Definition="Parental involvement activities uses of the Rural Low-Income Schools Program (RLIS) (Title VI, Part B, Subpart 2) Grant Funds.", SortOrder=Convert.ToDecimal("4.00") },
            new ReferenceModelBase { Id=Guid.Parse("3a36c126-4584-4c60-a2b9-30e309df96ec"), Code="05", Description="Activities authorized under the Safe and Drug-Free Schools Program (Title IV, Part A)", Definition="Activities authorized under the Safe and Drug-Free Schools Program (Title IV, Part A) using the Rural Low-Income Schools Program (RLIS) (Title VI, Part B, Subpart 2) Grant Funds.", SortOrder=Convert.ToDecimal("5.00") },
            new ReferenceModelBase { Id=Guid.Parse("a03515dc-8b9e-4b84-adec-49cd4248dcaf"), Code="06", Description="Activities authorized under Title I, Part A", Definition="Activities authorized under Title I, Part A using the Rural Low-Income Schools Program (RLIS) (Title VI, Part B, Subpart 2) Grant Funds.", SortOrder=Convert.ToDecimal("6.00") },
            new ReferenceModelBase { Id=Guid.Parse("686bfa3c-a387-4542-b023-d1004fef1e34"), Code="07", Description="Activities authorized under Title III (Language instruction for English Learner and immigrant students)", Definition="Activities authorized under Title III (Language instruction for English Learner and immigrant students) using the Rural Low-Income Schools Program (RLIS) (Title VI, Part B, Subpart 2) Grant Funds.", SortOrder=Convert.ToDecimal("7.00") },
        };
        #endregion
    }
}
