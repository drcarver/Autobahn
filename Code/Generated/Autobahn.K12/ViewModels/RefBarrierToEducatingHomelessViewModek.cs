...
//* FileName:   RefBarrierToEducatingHomelessViewModel.cs
//**********************************************************
...
{
     /// <summary>
     /// The RefBarrierToEducatingHomelessViewModel
     /// </summary>
    public partial class RefBarrierToEducatingHomelessViewModel : BindableBase, IRefBarrierToEducatingHomeless
    {
...
#region Properties
        ...
        /// </summary>
        public void Load(IRefBarrierToEducatingHomeless model)
        {
            IsBusy = true;
            Id = model.Id;
