...
//* FileName:   RefLeaTypeViewModel.cs
//**********************************************************
...
{
     /// <summary>
     /// The RefLeaTypeViewModel
     /// </summary>
    public partial class RefLeaTypeViewModel : BindableBase, IRefLeaType
    {
...
#region Properties
        ...
        /// </summary>
        public void Load(IRefLeaType model)
        {
            IsBusy = true;
            Id = model.Id;
