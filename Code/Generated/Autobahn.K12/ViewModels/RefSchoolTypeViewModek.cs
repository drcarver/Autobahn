...
//* FileName:   RefSchoolTypeViewModel.cs
//**********************************************************
...
{
     /// <summary>
     /// The RefSchoolTypeViewModel
     /// </summary>
    public partial class RefSchoolTypeViewModel : BindableBase, IRefSchoolType
    {
...
#region Properties
        ...
        /// </summary>
        public void Load(IRefSchoolType model)
        {
            IsBusy = true;
            Id = model.Id;
