...
//* FileName:   RefCharterSchoolAuthorizerTypeViewModel.cs
//**********************************************************
...
{
     /// <summary>
     /// The RefCharterSchoolAuthorizerTypeViewModel
     /// </summary>
    public partial class RefCharterSchoolAuthorizerTypeViewModel : BindableBase, IRefCharterSchoolAuthorizerType
    {
...
#region Properties
        ...
        /// </summary>
        public void Load(IRefCharterSchoolAuthorizerType model)
        {
            IsBusy = true;
            Id = model.Id;
