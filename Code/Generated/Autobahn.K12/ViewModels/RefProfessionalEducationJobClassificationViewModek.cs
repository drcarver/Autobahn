...
//* FileName:   RefProfessionalEducationJobClassificationViewModel.cs
//**********************************************************
...
{
     /// <summary>
     /// The RefProfessionalEducationJobClassificationViewModel
     /// </summary>
    public partial class RefProfessionalEducationJobClassificationViewModel : BindableBase, IRefProfessionalEducationJobClassification
    {
...
#region Properties
        ...
        /// </summary>
        public void Load(IRefProfessionalEducationJobClassification model)
        {
            IsBusy = true;
            Id = model.Id;
