...
//* FileName:   RefActivityTimeMeasurementTypeViewModel.cs
//**********************************************************
...
{
     /// <summary>
     /// The RefActivityTimeMeasurementTypeViewModel
     /// </summary>
    public partial class RefActivityTimeMeasurementTypeViewModel : BindableBase, IRefActivityTimeMeasurementType
    {
...
#region Properties
        ...
        /// </summary>
        public void Load(IRefActivityTimeMeasurementType model)
        {
            IsBusy = true;
            Id = model.Id;
