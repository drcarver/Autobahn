...
namespace Autobahn.K12.ViewModels
{
    ...
    public partial class K12SchoolStatusViewModel : ViewModelBase, Interfaces.IK12SchoolStatus
    {
        ...
        {
            new ReferenceModelBase { Id=Guid.Parse("faa94baa-020e-4d89-a515-78e70da23da4"), Code="All", Description="All students participate", Definition="All students participate in the academic or social focus of the magnet or special program emphasis school.", SortOrder=Convert.ToDecimal("1.00") },
            new ReferenceModelBase { Id=Guid.Parse("91174853-74d6-4244-8ca4-cbe04f3142e2"), Code="None", Description="No students participate", Definition="No students participate in the academic or social focus of the magnet or special program emphasis school.", SortOrder=Convert.ToDecimal("2.00") },
            new ReferenceModelBase { Id=Guid.Parse("e5223339-cef5-4ad5-abc0-cde294050209"), Code="Some", Description="Some, but not all, students participate", Definition="Some, but not all, students participate in the academic or social focus of the magnet or special program emphasis school.", SortOrder=Convert.ToDecimal("3.00") },
        };
        #endregion
        ...
        {
            new ReferenceModelBase { Id=Guid.Parse("c4232a5f-c248-4802-872d-ddb4cedfd191"), Code="NSLPCEO", Description="Community Eligibility Option", Definition="The classification of participation by the school in the National School Lunch Program is participating under the Community Eligibility Option.", SortOrder=Convert.ToDecimal("1.00") },
            new ReferenceModelBase { Id=Guid.Parse("76448310-84bc-4f01-b351-b110ff5b448e"), Code="NSLPNO", Description="Not Participating", Definition="The classification of participation by the school in the National School Lunch Program is not participating.", SortOrder=Convert.ToDecimal("2.00") },
            new ReferenceModelBase { Id=Guid.Parse("0cee2f0e-2fbe-4d75-a716-5848cb57f946"), Code="NSLPWOPRO", Description="Participating Without Provision or Community Eligibility Option", Definition="The classification of participation by the school in the National School Lunch Program is participating without using any Provision or the Community Eligibility Option.", SortOrder=Convert.ToDecimal("3.00") },
            new ReferenceModelBase { Id=Guid.Parse("0e06162b-6289-4cd7-89f3-5b5b5433e8a2"), Code="NSLPPRO1", Description="Provision 1", Definition="The classification of participation by the school in the National School Lunch Program is participating under Provision 1.", SortOrder=Convert.ToDecimal("4.00") },
            new ReferenceModelBase { Id=Guid.Parse("4bd0d177-c2d7-453d-bf8e-c5165cb98c89"), Code="NSLPPRO2", Description="Provision 2", Definition="The classification of participation by the school in the National School Lunch Program is participating under Provision 2.", SortOrder=Convert.ToDecimal("5.00") },
            new ReferenceModelBase { Id=Guid.Parse("1122b76e-5700-4372-9bcd-26d48238ad67"), Code="NSLPPRO3", Description="Provision 3", Definition="The classification of participation by the school in the National School Lunch Program is participating under Provision 3.", SortOrder=Convert.ToDecimal("6.00") },
        };
        #endregion
        ...
        {
            new ReferenceModelBase { Id=Guid.Parse("0d61ca21-14c5-4c78-9b49-7209316c988f"), Code="NOSTUDENTS", Description="No students in the subgroup", Definition="There are no students in a student subgroup.", SortOrder=Convert.ToDecimal("1.00") },
            new ReferenceModelBase { Id=Guid.Parse("16292654-bc0f-4306-b6c0-a0249e858763"), Code="STTDEF", Description="State defined status", Definition="A status defined by the state.", SortOrder=Convert.ToDecimal("2.00") },
            new ReferenceModelBase { Id=Guid.Parse("8aa1829f-56d1-468e-8d1b-f757454c7d2b"), Code="TOOFEW", Description="Too few students", Definition="The number of students in the school or for a student group was less than the minimum group size necessary or required to reliably calculate the indicator.", SortOrder=Convert.ToDecimal("3.00") },
        };
        #endregion
        ...
        {
            new ReferenceModelBase { Id=Guid.Parse("287ac571-7ec3-4f64-b84d-ce9b033ba994"), Code="RA1", Description="Replacement of all or most of the school staff (which may include the principal)", Definition="Replacement of all or most of the school staff (which may include the principal) is the type of actions being implemented in Title I schools as a result of the school being in an improvement status of restructuring - year 2 (implementation year).", SortOrder=Convert.ToDecimal("1.00") },
            new ReferenceModelBase { Id=Guid.Parse("56b186ab-10b3-41b2-aa9b-54ae090b8122"), Code="RA2", Description="Reopening the school as a public charter school", Definition="Reopening the school as a public charter school is the type of actions being implemented in Title I schools as a result of the school being in an improvement status of restructuring - year 2 (implementation year).", SortOrder=Convert.ToDecimal("2.00") },
            new ReferenceModelBase { Id=Guid.Parse("7e29f03f-315b-42bf-9ad3-f5e4a3ee9f0e"), Code="RA3", Description="Entering into a contract with a private entity to operate the school", Definition="Entering into a contract with a private entity to operate the school is the type of actions being implemented in Title I schools as a result of the school being in an improvement status of restructuring - year 2 (implementation year).", SortOrder=Convert.ToDecimal("3.00") },
            new ReferenceModelBase { Id=Guid.Parse("770faa7b-fdee-4d53-8c5a-e4a0cdd1dc70"), Code="RA4", Description="Take of the school by the state", Definition="Take of the school by the state is the type of actions being implemented in Title I schools as a result of the school being in an improvement status of restructuring - year 2 (implementation year).", SortOrder=Convert.ToDecimal("4.00") },
            new ReferenceModelBase { Id=Guid.Parse("99ef1515-2f8c-48ff-9c97-8ef856f6d73a"), Code="RA5", Description="Other major restructuring of the school governance", Definition="Other major restructuring of the school governance is the type of actions being implemented in Title I schools as a result of the school being in an improvement status of restructuring - year 2 (implementation year).", SortOrder=Convert.ToDecimal("5.00") },
        };
        #endregion
        ...
        {
            new ReferenceModelBase { Id=Guid.Parse("01c9f115-afd1-4fed-9f23-db948a1865d8"), Code="TGELGBNOPROG", Description="Title I Targeted Assistance Eligible School- No Program", Definition="The school is designated under state and federal regulations as being eligible for participation in Title I Targeted Assistance Eligible School- No Program.", SortOrder=Convert.ToDecimal("1.00") },
            new ReferenceModelBase { Id=Guid.Parse("2eff3d88-c61b-4f06-949d-700515d63c3b"), Code="TGELGBTGPROG", Description="Title I Targeted Assistance School", Definition="The school is designated under state and federal regulations as being eligible for participation in Title I Targeted Assistance School.", SortOrder=Convert.ToDecimal("2.00") },
            new ReferenceModelBase { Id=Guid.Parse("6642fa5d-3e61-49d9-9bb7-b586cca0576b"), Code="SWELIGTGPROG", Description="Title I, Schoolwide eligible-Title I Targeted Assistance Program", Definition="The school is designated under state and federal regulations as being eligible for participation in Title I, Schoolwide eligible-Title I Targeted Assistance Program.", SortOrder=Convert.ToDecimal("3.00") },
            new ReferenceModelBase { Id=Guid.Parse("bd5c89d0-4374-484f-b052-55f0cf6616d5"), Code="SWELIGNOPROG", Description="Title I Schoolwide Eligible School - No Program", Definition="The school is designated under state and federal regulations as being eligible for participation in Title I Schoolwide Eligible School - No Program.", SortOrder=Convert.ToDecimal("4.00") },
            new ReferenceModelBase { Id=Guid.Parse("86dbaef7-0bd0-4e56-8b3c-98fed158dd6e"), Code="SWELIGSWPROG", Description="Title I Schoolwide School", Definition="The school is designated under state and federal regulations as being eligible for participation in Title I Schoolwide School.", SortOrder=Convert.ToDecimal("5.00") },
            new ReferenceModelBase { Id=Guid.Parse("a3d6140c-c2d7-4d3f-bc6a-eb9030249200"), Code="NOTTITLE1ELIG", Description="Not a Title I School", Definition="The school is designated under state and federal regulations as being Not a Title I School.", SortOrder=Convert.ToDecimal("6.00") },
        };
        #endregion
        ...
        {
            new ReferenceModelBase { Id=Guid.Parse("04e41278-7a28-4c27-86e5-05dfc645505b"), Code="FaceVirtual", Description="Face Virtual", Definition="The school focuses on a systematic program of virtual instruction but includes some physical meetings among students or with teachers.", SortOrder=Convert.ToDecimal("1.00") },
            new ReferenceModelBase { Id=Guid.Parse("0ab4cd5d-36aa-430f-961f-08675ceea711"), Code="FullVirtual", Description="Full Virtual", Definition="The school has no physical building where students meet with each other or with teachers and all instruction is virtual.", SortOrder=Convert.ToDecimal("2.00") },
            new ReferenceModelBase { Id=Guid.Parse("0374bbb9-5b01-41a9-86a3-8a1bebba4434"), Code="NotVirtual", Description="Not Virtual", Definition="The school does not offer any virtual instruction.", SortOrder=Convert.ToDecimal("3.00") },
            new ReferenceModelBase { Id=Guid.Parse("53d9c321-b1d5-48ba-9c22-56462e0a1749"), Code="SupplementalVirtual", Description="Supplemental Virtual", Definition="The school offers virtual courses but virtual instruction is not the primary means of instruction.", SortOrder=Convert.ToDecimal("4.00") },
        };
        #endregion
    }
}
