...
//* FileName:   RefSpecialEducationAgeGroupTaughtViewModel.cs
//**********************************************************
...
{
     /// <summary>
     /// The RefSpecialEducationAgeGroupTaughtViewModel
     /// </summary>
    public partial class RefSpecialEducationAgeGroupTaughtViewModel : BindableBase, IRefSpecialEducationAgeGroupTaught
    {
...
#region Properties
        ...
        /// </summary>
        public void Load(IRefSpecialEducationAgeGroupTaught model)
        {
            IsBusy = true;
            Id = model.Id;
