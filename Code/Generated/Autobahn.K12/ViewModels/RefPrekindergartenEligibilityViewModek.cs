...
//* FileName:   RefPrekindergartenEligibilityViewModel.cs
//**********************************************************
...
{
     /// <summary>
     /// The RefPrekindergartenEligibilityViewModel
     /// </summary>
    public partial class RefPrekindergartenEligibilityViewModel : BindableBase, IRefPrekindergartenEligibility
    {
...
#region Properties
        ...
        /// </summary>
        public void Load(IRefPrekindergartenEligibility model)
        {
            IsBusy = true;
            Id = model.Id;
