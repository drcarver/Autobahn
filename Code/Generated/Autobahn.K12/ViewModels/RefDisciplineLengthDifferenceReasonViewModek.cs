...
//* FileName:   RefDisciplineLengthDifferenceReasonViewModel.cs
//**********************************************************
...
{
     /// <summary>
     /// The RefDisciplineLengthDifferenceReasonViewModel
     /// </summary>
    public partial class RefDisciplineLengthDifferenceReasonViewModel : BindableBase, IRefDisciplineLengthDifferenceReason
    {
...
#region Properties
        ...
        /// </summary>
        public void Load(IRefDisciplineLengthDifferenceReason model)
        {
            IsBusy = true;
            Id = model.Id;
