...
//* FileName:   RefStateANSICodeViewModel.cs
//**********************************************************
...
{
     /// <summary>
     /// The RefStateANSICodeViewModel
     /// </summary>
    public partial class RefStateANSICodeViewModel : BindableBase, IRefStateANSICode
    {
...
#region Properties
        ...
        /// </summary>
        public void Load(IRefStateANSICode model)
        {
            IsBusy = true;
            Id = model.Id;
            Code = model.Code;
