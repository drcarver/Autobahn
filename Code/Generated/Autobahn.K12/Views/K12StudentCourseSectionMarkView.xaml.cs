...
namespace Autobahn.K12.Views
{
    ...
    {
        /// <summary>
        /// Inject the IK12StudentCourseSectionMarkViewModel as the data context for the view
        /// </summary>
        public K12StudentCourseSectionMarkView(IK12StudentCourseSectionMarkViewModel vm)
        {
            BindingContext  = vm;
        }
    }
